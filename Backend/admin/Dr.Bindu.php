...
if(isset($_POST['submit'])) {
    if(isset($_GET['id'])){
        $data_id = $_GET['id'];
        $bindu = "select * from `Dr.Bindu` where id = '$data_id'";
...
<body>
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class='nav-item'>
            <a class='nav-link active' aria-current='page' href='dr.bindumain.php'>Dr. Bindu Thakral</a></li>
            <li class='nav-item'>
            <a class='nav-link active' aria-current='page' href='kshitijmain.php'>Mr. Kshitij Gupta</a></li>
            <li class='nav-item'>
